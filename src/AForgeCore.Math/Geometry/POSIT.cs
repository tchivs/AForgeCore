...
namespace AForgeCore.Math.Geometry
{
    using System;
    using AForgeCore;
    ...
    /// AForgeCore.Point[] projectedPoints = new AForgeCore.Point[4]
    /// {
    ///     new AForgeCore.Point(   -4,   29 ),
    ///     new AForgeCore.Point( -180,   86 ),
    ///     new AForgeCore.Point(   -5, -102 ),
    ///     new AForgeCore.Point(   76,  137 ),
    /// };
    /// // estimate pose
