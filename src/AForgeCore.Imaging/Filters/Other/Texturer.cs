...
//
namespace AForgeCore.Imaging.Filters
{
    using System;
    ...
    {
        // texture generator
        private AForgeCore.Imaging.Textures.ITextureGenerator textureGenerator;
        // generated texture
        ...
        /// </remarks>
        /// 
        public AForgeCore.Imaging.Textures.ITextureGenerator TextureGenerator
        {
        ...
        /// 
        public Texturer( AForgeCore.Imaging.Textures.ITextureGenerator generator ) : this( )
        {
        ...
        /// <param name="preserveLevel">Preserve level value (see <see cref="PreserveLevel"/> property).</param>
        /// 
        public Texturer( AForgeCore.Imaging.Textures.ITextureGenerator generator, double filterLevel, double preserveLevel )
            : this( )
        {
            this.textureGenerator = generator;
            this.filterLevel = filterLevel;
