...
//
// Copyright ?AForgeCore.NET, 2005-2011
...
namespace AForgeCore.Imaging.Filters
{
    ...
    /// the kernel, which is calculate with the help of <see cref="AForgeCore.Math.Gaussian.Kernel2D"/>
    ...
    /// <see cref="AForgeCore.Math.Gaussian.Sigma">sigma value of Gaussian function</see>.</para>
    /// 
    ...
    public sealed class GaussianBlur : Convolution
    {
        ...
        private void CreateFilter( )
        {
            ...
            AForgeCore.Math.Gaussian gaus = new AForgeCore.Math.Gaussian( sigma );
            // create kernel
