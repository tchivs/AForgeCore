...
namespace AForgeCore.Imaging
{
    ...
    using AForgeCore;
    using AForgeCore.Math.Geometry;
    ...
    /// <see cref="AForgeCore.Math.Geometry.PointsCloud.FindQuadrilateralCorners"/> to find corners
    ...
    /// 
    /// // lock image to draw on it with AForgeCore.NET's methods
