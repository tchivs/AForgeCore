...
namespace AForgeCore.Imaging.Textures
{
    using System;
    ...
    /// 
    /// <para>The generator is based on the <see cref="AForgeCore.Math.PerlinNoise">Perlin noise function</see>.</para>
    /// 
    ...
    public class LabyrinthTexture : ITextureGenerator
    {
        ...
        private AForgeCore.Math.PerlinNoise noise = new AForgeCore.Math.PerlinNoise( 1, 0.65, 1.0 / 16, 1.0 );
