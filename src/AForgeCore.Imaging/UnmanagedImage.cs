...
//
// Copyright © AForgeCore.NET, 2005-2012
// contacts@aforgenet.com
//

namespace AForgeCore.Imaging
{
    using System;
    ...
    public class UnmanagedImage : IDisposable
    {
        ...
        public UnmanagedImage Clone( )
        {
            ...
            AForgeCore.SystemTools.CopyUnmanagedMemory( newImageData, imageData, stride * height );
        ...
        public void Copy( UnmanagedImage destImage )
        {
            ...
            {
                // copy entire image
                AForgeCore.SystemTools.CopyUnmanagedMemory( destImage.imageData, imageData, stride * height );
            }
            else
            {
                unsafe
                {
                    ...
                    {
                        AForgeCore.SystemTools.CopyUnmanagedMemory( dst, src, copyLength );
        ...
        public static UnmanagedImage Create( int width, int height, PixelFormat pixelFormat )
        {
            ...
            AForgeCore.SystemTools.SetUnmanagedMemory( imageData, 0, stride * height );
            System.GC.AddMemoryPressure( stride * height );
            ...
            try
            {
                ...
                else
                {
                    ...
                    dstImage = ( pixelFormat == PixelFormat.Format8bppIndexed ) ?
                        AForgeCore.Imaging.Image.CreateGrayscaleImage( width, height ) :
                    ...
                    unsafe
                    {
                        ...
                        if ( stride != dstStride )
                        {
                            ...
                            {
                                AForgeCore.SystemTools.CopyUnmanagedMemory( dst, src, lineSize );
                                dst += dstStride;
                                src += stride;
                            }
                        }
                        ...
                        {
                            AForgeCore.SystemTools.CopyUnmanagedMemory( dst, src, stride * height );
                        }
                    }
        ...
        public static UnmanagedImage FromManagedImage( BitmapData imageData )
        {
            ...
            AForgeCore.SystemTools.CopyUnmanagedMemory( dstImageData, imageData.Scan0, imageData.Stride * imageData.Height );
            image.mustBeDisposed = true;
