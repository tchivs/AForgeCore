// AForgeCore Image Formats Library
...
namespace AForgeCore.Imaging.Formats
{
    using System;
    ...
    /// <summary>
    /// Set of tools used internally in AForgeCore.Imaging.Formats library.
    /// </summary>
    internal class Tools
    {
        ...
        /// 
        /// <remarks><para>AForgeCore.Imaging.Image.CreateGrayscaleImage() function
        /// could be used instead, which does the some. But it was not used to get
        /// rid of dependency on AForgeCore.Imaing library.</para></remarks>
        /// 
